...
| 02 | [02-Redis面试题.md](./02-Redis面试题.md) | Redis 数据结构 / 持久化 / 内存管理 / 网络模型 / 集群 / 事务 22 道分层面试题 | [技术资料](../../01-技术资料/03-数据库/02-Redis核心技术.md) |
...
| 05 | [05-数据库高可用与安全面试题.md](./05-数据库高可用与安全面试题.md) | RTO/RPO、同步/异步/半同步复制、故障切换、备份与演练、TLS/TDE/字段加密、审计与多租户隔离、防护场景题 | [技术资料](../../01-技术资料/03-数据库/05-数据库高可用与安全.md) |
