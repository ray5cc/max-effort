...
| 03 | [03-分布式系统基础.md](./03-分布式系统基础.md) | CAP 定理 / Raft 共识 / 分布式事务(2PC/Saga/TCC) / 一致性哈希 / 缓存策略 / 容错模式 | [面试题](../../02-面试指南/05-系统设计面试/04-分布式系统面试题.md) |
| 04 | [04-消息队列与流处理.md](./04-消息队列与流处理.md) | Kafka/RabbitMQ/Pulsar 对比 / 消息可靠性 / 流处理 / 消息积压处理 | [面试题](../../02-面试指南/05-系统设计面试/05-消息队列面试题.md) |
