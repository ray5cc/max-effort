...
| 03   | [03-分布式系统基础.md](./03-分布式系统基础.md)     | CAP 定理 / Raft 共识 / 分布式事务(2PC/Saga/TCC) / 一致性哈希 / 缓存策略 / 容错模式 / 分布式锁(Redis/Redlock/ZK) / 逻辑时钟 / CRDT / Gossip | [面试题](../../02-面试指南/05-系统设计面试/04-分布式系统面试题.md)  |
...
| 05   | [05-高可用与容灾架构.md](./05-高可用与容灾架构.md) | SLO/RTO/RPO、主备/多活拓扑、同步/异步/多数派复制、流量调度、熔断限流隔离、故障切换演练与数据校验                                           | [面试题](../../02-面试指南/05-系统设计面试/06-高可用与容灾面试题.md) |
