...
> DevOps 与云计算学习文档，涵盖 CI/CD、容器化、云服务及运维最佳实践。

## 相关链接

- 对应面试指南：[06-DevOps与云计算面试](../../02-面试指南/06-DevOps与云计算面试/README.md)
...
| 04 | [可观测性与 SRE](./04-可观测性与SRE.md) | Observability 三支柱、SLI/SLO/Error Budget、Burn Rate 告警、OTel 观测栈、Runbook 与无责 Postmortem、K8s 微服务观测实践 | [可观测性与 SRE 面试题](../../02-面试指南/06-DevOps与云计算面试/04-可观测性与SRE面试题.md) |
...
- SRE 可靠性工程（SLI/SLO、Error Budget、Runbook、Postmortem）

## 导航

- ← [技术资料总目录](../README.md)
- ↔ [DevOps与云计算面试指南](../../02-面试指南/06-DevOps与云计算面试/README.md)
